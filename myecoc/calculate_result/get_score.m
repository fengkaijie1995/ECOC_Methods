%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% this function wil get accurary,sensitivity,specifity,precision and fsoce
% input parameters are predicted labels and true test labels
% note that the final results is mean values of each clas
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function scores = get_score(testlabel,prelabel)
    res=[];
