%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% functon is to get group1, group2 and DC level between them
% parameters are random group1. random group2, traindata and trainlabel
% return most simplest group1, group2 and DC level between them
% note that this fucntion is different from the function 'get_complexityF1'
% the adjusted method is tailored for each DC measure 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
